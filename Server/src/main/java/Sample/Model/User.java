...
//    }
    ...
    public void setHighScore(int highscore) {
        System.out.println("set highscore called");

    }

    public void changeUsername(String newUsername) {
        System.out.println("change username called");

    }

    public void changeNickname(String nickname) {
        System.out.println("change nickname called");

    }

    public void changeEmail(String email) {
        System.out.println("change email called");
    }

    public void setPasswordRecovery(Object recovery) {
        System.out.println("set password recovery called");
    }
    ...
    public void removeFriend(User user) {
        System.out.println("remove freind called");
    }
    ...
    public void removeSender(User user) {
        System.out.println("remove user called");
    }
