...
//        System.out.println(response + ": received in register controller");
        ...
        User.saveUsers();
//        String allUsersJson = NetworkController.getAllUsersInJson();
        Client client = new Client();
        client.tryToConnectToServer("addNewUser~" + new Gson().toJson(newUser));
    ...
    private void handlePasswordField() {
        ...
        } else password.setText(showPassword.getText());
    }
