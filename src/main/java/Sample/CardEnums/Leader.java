...
public enum Leader {
    ...
    WhiteFlame("White Flame", Faction.Nilfgaard, "Plays a 'Torrential Rain' card.", new Image(Objects.requireNonNull(LoginMenu.class.getResourceAsStream("Images/CardImages/nilfgaard_emhyr_silver.jpg"))), new Image(Objects.requireNonNull(LoginMenu.class.getResourceAsStream("Images/CardGameImages/nilfgaard_emhyr_silver.jpg")))),
    ...
    CommanderOfTheRedRiders("Commander of the Red Riders", Faction.Monsters, "Plays a random weather card from your hand.", new Image(Objects.requireNonNull(LoginMenu.class.getResourceAsStream("Images/CardImages/monsters_eredin_copper.jpg"))), new Image(Objects.requireNonNull(LoginMenu.class.getResourceAsStream("Images/CardGameImages/monsters_eredin_copper.jpg")))),
    ...
    HopeOfTheAenSeidhe("Hope of the Aen Seidhe", Faction.Scoiatael, "Plays a 'Biting Frost' card.", new Image(Objects.requireNonNull(LoginMenu.class.getResourceAsStream("Images/CardImages/scoiatael_francesca_hope_of_the_aen_seidhe.jpg"))), new Image(Objects.requireNonNull(LoginMenu.class.getResourceAsStream("Images/CardGameImages/scoiatael_francesca_hope_of_the_aen_seidhe.jpg")))),
