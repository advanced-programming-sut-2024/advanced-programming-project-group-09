...
//            user2.setFactionSelected(Faction.Skellige);
//            user2.setFactionLeader(Leader.CrachAnCraite);
//            user2.getCommonCardsInDeck().add(CommonCard.YoungBerserker);
//            user2.getCommonCardsInDeck().add(CommonCard.YoungBerserker);
//            user2.getCommonCardsInDeck().add(CommonCard.Kambi);
//            user2.getCommonCardsInDeck().add(CommonCard.Kambi);
//            user2.getCommonCardsInDeck().add(CommonCard.Kambi);
//            user2.getCommonCardsInDeck().add(CommonCard.Kambi);
