...
public class ScoreBoardMenu extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        BackgroundImage backgroundImage = new BackgroundImage(new Image(String.valueOf(ScoreBoardMenu.class.getResource("Images/Profile.jpg")), 0, 0, false, true), BackgroundRepeat.NO_REPEAT, BackgroundRepeat.NO_REPEAT, BackgroundPosition.DEFAULT, new BackgroundSize(1.0, 1.0, true, true, false, false));
