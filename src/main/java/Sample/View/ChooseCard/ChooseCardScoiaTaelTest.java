...
public class ChooseCardScoiaTaelTest extends Application {
    ...
    public void start(Stage stage) throws Exception {
        ...
        URL url = LoginMenu.class.getResource("FXMl/ChooseCard/ChooseCardScoiaTael.fxml");
        assert url != null;
...
//        }
    ...
    public static void setMediaPlayer(MediaPlayer mediaPlayer) {
        ChooseCardScoiaTaelTest.mediaPlayer = mediaPlayer;
    }
}
