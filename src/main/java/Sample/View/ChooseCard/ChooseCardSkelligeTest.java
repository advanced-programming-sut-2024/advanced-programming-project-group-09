...
public class ChooseCardSkelligeTest extends Application {
    ...
    public void start(Stage stage) throws Exception {
        ...
        URL url = LoginMenu.class.getResource("FXMl/ChooseCard/ChooseCardSkellige.fxml");
        assert url != null;
...
//        }
    ...
    public static void setMediaPlayer(MediaPlayer mediaPlayer) {
        ChooseCardSkelligeTest.mediaPlayer = mediaPlayer;
    }
}
