...
public class RegisterController {
    ...
    private Gwent gwent = Gwent.getInstance();
    ...
    public void register() throws Exception {
        ...
        if (gwent.userExists(username.getText())) {
        ...
        newUser = new User(username.getText(), password.getText(), email.getText(), nickname.getText());
        gwent.addUser(newUser);
